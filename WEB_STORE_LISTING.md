...
Generated by `node design/shoot-store.mjs` (build first: `npx wxt build`) → `design/store/`:

- [x] `1-popup.png` — popup with five seeded spaces on aurora backdrop + headline
- [x] `2-sidepanel.png` — side panel Spaces tab on aurora backdrop + headline
- [x] `3-options.png` — options page: AI engine tiers + automation levels (direct shot)
- [x] `4-onboarding.png` — first-run onboarding step 1 (direct shot)

## Promo tile (440×280)

- [x] `design/store/promo-tile-440x280.png` — orb logo + tagline "On-device AI tab organization — nothing leaves your machine"
